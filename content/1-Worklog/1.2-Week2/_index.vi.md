...
* Nhóm đã chốt được dự án chính thức cho giai đoạn triển khai tiếp theo:
  * Xác định rõ mục tiêu và phạm vi thực hiện.
  * Thống nhất hướng triển khai phù hợp với thời gian bootcamp.
  * Có phân công trách nhiệm bước đầu cho từng thành viên.

* Nắm được kiến thức cơ bản về các dịch vụ AWS cần thiết cho dự án:
  * Hiểu vai trò của các nhóm dịch vụ chính: Compute, Storage, Networking, Database.
  * Phân biệt được một số dịch vụ tiêu biểu và tình huống sử dụng phù hợp.
  * Có bộ ghi chú nền để làm tài liệu tham chiếu cho các tuần tiếp theo.

* Hoàn thành thảo luận sơ bộ về các dịch vụ AWS sẽ áp dụng:
...
* Cải thiện khả năng phối hợp nhóm và tổ chức công việc:
  ...
  * Kế hoạch tuần sau được xác định theo mốc thời gian cụ thể.
  * Tinh thần phối hợp và chủ động trao đổi trong nhóm được nâng cao.
